...
const UserInterface: React.FC<UserInterfaceProps> = ({ backendName }) => {
  ...
  return (
    <div className={`user-interface ${bgColor} ${backendName} w-full max-w-md p-4 rounded shadow`}>
      <Image src='/next.svg' alt='nextjs Logo' width={20} height={20} className="w-20 h-20 mb-6 mx-auto" />
      <h2 className="text-xl font-bold text-center text-white mb-6">{`${backendName.charAt(0).toUpperCase() + backendName.slice(1)}-Next test JS User App`}</h2>
